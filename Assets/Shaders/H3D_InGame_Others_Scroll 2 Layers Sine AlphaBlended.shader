  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          float4 tmpvar_8;
          float _tmp_dvx_49 = sin((_Time * _SineFreqX));
          tmpvar_8 = float4(_tmp_dvx_49, _tmp_dvx_49, _tmp_dvx_49, _tmp_dvx_49);
          tmpvar_1.x = (tmpvar_1.x + (tmpvar_8 * _SineAmplX).x).x;
          float4 tmpvar_9;
          float _tmp_dvx_50 = sin((_Time * _SineFreqY));
          tmpvar_9 = float4(_tmp_dvx_50, _tmp_dvx_50, _tmp_dvx_50, _tmp_dvx_50);
          tmpvar_1.y = (tmpvar_1.y + (tmpvar_9 * _SineAmplY).x).x;
          float4 tmpvar_10;
          float _tmp_dvx_51 = sin((_Time * _SineFreqX2));
          tmpvar_10 = float4(_tmp_dvx_51, _tmp_dvx_51, _tmp_dvx_51, _tmp_dvx_51);
          tmpvar_1.z = (tmpvar_1.z + (tmpvar_10 * _SineAmplX2).x).x;
          float4 tmpvar_11;
          float _tmp_dvx_52 = sin((_Time * _SineFreqY2));
          tmpvar_11 = float4(_tmp_dvx_52, _tmp_dvx_52, _tmp_dvx_52, _tmp_dvx_52);
